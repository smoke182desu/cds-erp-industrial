...
export const TechnicalDrawing: React.FC<TechnicalDrawingProps> = ({
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-950 rounded-lg border border-zinc-800 p-4">
      {/* Close Button - Moved to Viewer3D for better control, but adding a local one just in case */}
      <div className="absolute top-2 right-2 lg:top-4 lg:right-4 z-50">
        {/* The actual close button is in Viewer3D.tsx, this is just a fallback or helper */}
      </div>
