...
export const EscadaL: React.FC<EscadaLProps> = ({
  ...
  return (
    <group position={[0, -hTotal / 2, -pZ / 2]}>
      ...
      {/* COBERTURA: 2 telhados metalon (1 por lance), colunas apoiadas no degrau */}
      {temCobertura && (() => {
        const beiral = 0.12;
        ...
        const roof = (kp: string, zS: number, zE: number, yS: number, yE: number) => {
          ...
          return (
            <group key={kp}>
              <PecaParametrica pontoInicio={[xL, yS, zF]} pontoFim={[xL, yF, zF]} perfil={colP} tipoCorte="reto" acabamentoMetal={acabamentoMetal} up={[0, 0, 1]} colorOverride={colorViga} />
              <PecaParametrica pontoInicio={[xR, yS, zF]} pontoFim={[xR, yF, zF]} perfil={colP} tipoCorte="reto" acabamentoMetal={acabamentoMetal} up={[0, 0, 1]} colorOverride={colorViga} />
              <PecaParametrica pontoInicio={[xL, yE, zB]} pontoFim={[xL, yB, zB]} perfil={colP} tipoCorte="reto" acabamentoMetal={acabamentoMetal} up={[0, 0, 1]} colorOverride={colorViga} />
              <PecaParametrica pontoInicio={[xR, yE, zB]} pontoFim={[xR, yB, zB]} perfil={colP} tipoCorte="reto" acabamentoMetal={acabamentoMetal} up={[0, 0, 1]} colorOverride={colorViga} />
