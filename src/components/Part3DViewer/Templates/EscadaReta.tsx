...
export const EscadaReta: React.FC<EscadaRetaProps> = ({ 
  ...
  return (
    <group position={[0, -h / 2, -comprimentoTotal / 2]}>
      {/* Degraus */}
      <group name="Degraus" position={exp(0, 0, 0.4)}>
        ...
        {explodedFactor > 0.5 && <Label text="Degraus" position={[0, h/2, comprimentoTotal/2]} />}
      </group>
      ...
      <group position={exp(-0.4, 0, 0)}>
        ...
        />
        {explodedFactor > 0.5 && <Label text="Viga Lateral Esq." position={[-w/2 - 0.2, h/2, comprimentoTotal/2]} />}
      </group>
      ...
      <group position={exp(0.4, 0, 0)}>
        <PecaParametrica
          ...
          colorOverride={colorViga}
        />
        {explodedFactor > 0.5 && <Label text="Viga Lateral Dir." position={[w/2 + 0.2, h/2, comprimentoTotal/2]} />}
      </group>
      ...
      <group position={exp(0, 0.4, 0)}>
        ...
        {explodedFactor > 0.5 && temGuardaCorpo && <Label text="Guarda-Corpo" position={[0, h + 1.2, comprimentoTotal/2]} />}
      </group>
