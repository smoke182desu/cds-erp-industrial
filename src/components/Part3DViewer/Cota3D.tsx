...
export const Cota3D: React.FC<Cota3DProps> = ({
  ...
  return (
    <group>
      ...
      >
        <div 
          className="px-2 py-1 text-[10px] font-black whitespace-normal break-words max-w-[150px] rounded bg-white/90 border border-slate-200 shadow-md backdrop-blur-sm transition-all"
          style={{ 
            color: cor,
