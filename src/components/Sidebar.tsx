...
export function Sidebar({ 
  ...
  return (
    <>
      <div className="w-80 bg-white border-r border-slate-300 flex flex-col h-full shadow-lg z-10">
        <div className="p-6 border-b border-slate-200 bg-gradient-to-b from-slate-50 to-white flex justify-between items-center">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 font-medium">Braço Direito da Engenharia</p>
            </div>
          </div>
          {onClose && (
            <button 
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <span className="block text-xs text-slate-600">Comece com um clique</span>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xs font-bold text-slate-600 uppercase tracking-wider">Projeto Atual</h2>
              <span className="text-xs font-mono bg-slate-100 px-2 py-1 rounded text-slate-600">v{project.version.toFixed(1)}</span>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="bg-white p-2 rounded-lg border border-slate-200">
                  <span className="text-xs text-slate-600 block mb-1">Material</span>
                  <span className="font-medium text-slate-700">{project.material}</span>
                </div>
                <div className="bg-white p-2 rounded-lg border border-slate-200">
                  <span className="text-xs text-slate-600 block mb-1">Peso Est.</span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="group">
                <label className="text-xs font-medium text-slate-600 mb-1 block group-hover:text-blue-600 transition-colors">Largura (W)</label>
                <div className="relative">
                  <input 
                    type="number" 
                    value={project.dimensions.width || 0}
                    readOnly
                    className="w-full bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-sm font-mono text-slate-600 focus:outline-none cursor-not-allowed"
                  />
              ...
              <div className="group">
                <label className="text-xs font-medium text-slate-600 mb-1 block group-hover:text-blue-600 transition-colors">Altura (H)</label>
                <div className="relative">
                  <input 
                    type="number" 
              ...
              <div className="group">
                <label className="text-xs font-medium text-slate-600 mb-1 block group-hover:text-blue-600 transition-colors">Profundidade (D)</label>
                <div className="relative">
                  <input 
                    type="number" 
            ...
            <p className="text-xs text-slate-600 italic bg-blue-50 p-2 rounded border border-blue-100">
        ...
        <div className="p-4 border-t border-slate-300 bg-slate-50 space-y-3">
          <div className="grid grid-cols-2 gap-2">
            <button 
              onClick={onSave}
              className="flex items-center justify-center gap-2 px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-100 hover:border-slate-400 transition-all shadow-sm"
          ...
          <button 
            onClick={onReset}
            className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-slate-600 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors"
          >
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-white/80 backdrop-blur-sm p-4">
            ...
            >
              <div className="p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Escolha um modelo base para começar rapidamente</p>
                  </div>
                </div>
              ...
              <div className="flex flex-1 overflow-hidden">
                {/* Category Sidebar */}
                <div className="w-72 bg-slate-50 border-r border-slate-300 overflow-y-auto p-4 space-y-2 shrink-0">
                  <button
                  ...
                  <div className="pt-2 pb-1">
                    <p className="px-4 text-xs font-bold text-slate-600 uppercase tracking-wider">Categorias</p>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {filteredTemplates.map((template) => (
                        <button 
                          ...
                          className="group bg-white hover:bg-blue-50 border border-slate-300 hover:border-blue-200 p-5 rounded-xl transition-all text-left shadow-sm hover:shadow-md flex flex-col h-full"
                        >
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <span className="text-xs font-mono bg-slate-100 px-2 py-1 rounded text-slate-600 group-hover:bg-blue-100 group-hover:text-blue-600">
