...
const sections: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'WooCommerce', icon: ShoppingBag, id: 'woocommerce', badge: 'SYNC' },
    ],
  },
  {
