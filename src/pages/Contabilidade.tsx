    ...
    <div className="h-full flex flex-col gap-6 p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-400 text-sm">Margem de Lucro Líquida</p>
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl flex items-center gap-4">
          ...
          <div>
            <p className="text-slate-400 text-sm">Ponto de Equilíbrio (Break-even)</p>
            <p className="text-2xl font-bold text-white">R$ 138.888,00</p>
          </div>
        </div>
      </div>
          ...
          return (
            <div key={index} className="flex items-center justify-between p-4 bg-slate-950 rounded-lg border border-slate-800">
              ...
              <div className="flex items-center gap-6">
                ...
                <span className="text-slate-400 font-mono text-sm w-16 text-right">{item.percentage}%</span>
              </div>
            </div>
          );
        })}
