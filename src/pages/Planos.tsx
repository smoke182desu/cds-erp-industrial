    ...
    <div className="max-w-5xl mx-auto p-8">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <motion.div 
          ...
          className={`bg-slate-900 rounded-3xl p-8 border-2 relative overflow-hidden ${planoAtual === 'pro' ? 'border-blue-500 shadow-2xl shadow-blue-900/20' : 'border-slate-800 shadow-xl'}`}
        >
          ...
          <div className="mb-8 relative z-10">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-xl font-medium text-slate-400">,90</span>
              <span className="text-slate-400 ml-1">/mês</span>
            </div>
            <p className="text-slate-400 mt-2 text-sm">A ferramenta definitiva para fechar mais negócios.</p>
          </div>
