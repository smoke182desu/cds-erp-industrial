    ...
    <div className="h-screen flex flex-col bg-slate-100 font-sans">
      ...
      <main className="flex-1 relative flex flex-col md:flex-row">
        ...
        {config.tipoProduto === 'portao_basculante' && (
          <div className="absolute bottom-24 left-1/2 transform -translate-x-1/2 w-full max-w-md px-4 md:static md:transform-none md:w-80 md:h-full md:border-l md:border-slate-200 md:bg-white md:p-6 md:flex md:flex-col md:justify-center">
            <div className="bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-slate-200/50">
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-slate-200 p-4 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-10">
        <div className="flex items-center gap-4 text-sm">
          <div className="flex flex-col">
            <span className="text-slate-500 font-medium">Dimensões Totais</span>
