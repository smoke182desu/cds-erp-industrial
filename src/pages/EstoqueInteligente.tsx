    ...
    <div className="h-full flex flex-col gap-6 p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white border border-slate-200 p-6 rounded-xl">
          <p className="text-slate-600 text-sm">Total de Itens no Catálogo</p>
          <p className="text-3xl font-bold text-slate-900">{summary.totalItens}</p>
        </div>
        <div className="bg-white border border-slate-200 p-6 rounded-xl">
          <p className="text-slate-600 text-sm">Itens em Alerta (Falta)</p>
          <p className="text-3xl font-bold text-rose-400">{summary.itensEmAlerta}</p>
        </div>
        <div className="bg-white border border-slate-200 p-6 rounded-xl">
          <p className="text-slate-600 text-sm">Valor em Estoque (Custo)</p>
