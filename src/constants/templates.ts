...
export const PROJECT_TEMPLATES: Template[] = [
  ...
  {
    id: 'stair-straight',
    name: 'Escada Reta Industrial',
    description: 'Escada metálica industrial pesada com banzos em Perfil U e degraus em chapa xadrez.',
    category: 'Estruturas Arquitetônicas e Acessos',
    icon: 'Layers',
    project: {
      name: 'Escada Reta Industrial 3m',
      tipoProduto: 'escada_reta',
      dimensions: { width: 1000, height: 3000, depth: 3600 },
      material: 'perfil-u-150x50',
      components: []
    }
  },
  {
  ...
  },
  {
    ...
    description: 'Ponto de ônibus com estrutura metálica, fechamento em vidro e mobiliário.',
    category: 'Utilidades Domésticas e Urbanas',
    icon: 'Bus',
    project: {
      name: 'Abrigo de Ônibus Padrão',
      tipoProduto: 'abrigo_onibus',
      dimensions: { width: 4000, height: 2500, depth: 1600 },
      material: 'tubo-100x100',
      components: []
    }
  },
  {
    id: 'carrinho-plataforma',
    name: 'Carrinho Plataforma',
    description: 'Carrinho plataforma industrial com chapa xadrez e rodízios pesados.',
    category: 'Utilidades Domésticas e Urbanas',
    icon: 'Truck',
    project: {
      name: 'Carrinho Plataforma 80x120',
      tipoProduto: 'carrinho_plataforma',
      dimensions: { width: 800, height: 1050, depth: 1200 },
      material: 'cantoneira-40x40',
      components: []
    }
  },
  {
    id: 'gaiola-roll-container',
    name: 'Gaiola Roll Container',
    description: 'Carrinho aramado logístico para movimentação e armazenagem.',
    category: 'Utilidades Domésticas e Urbanas',
    icon: 'Package',
    project: {
      name: 'Gaiola Roll Container 80x70x170',
      tipoProduto: 'gaiola_roll_container',
      dimensions: { width: 800, height: 1700, depth: 700 },
      material: 'tubo-30x30',
      components: []
    }
  },
  {
    id: 'carrinho-cilindros',
    name: 'Carrinho de Cilindros',
    description: 'Carrinho para transporte de gases industriais com rodas maciças.',
    category: 'Utilidades Domésticas e Urbanas',
    icon: 'Truck',
    project: {
      name: 'Carrinho de Cilindros Padrão',
      tipoProduto: 'carrinho_cilindros',
      dimensions: { width: 500, height: 1300, depth: 450 },
      material: 'tubo-1.1/4',
      components: []
    }
  },
  {
    id: 'reboque-industrial',
    name: 'Reboque Industrial',
    description: 'Carrinho plataforma direcional pesadíssimo com quinta roda.',
    category: 'Utilidades Domésticas e Urbanas',
    icon: 'Truck',
    project: {
      name: 'Reboque Industrial 100x200',
      tipoProduto: 'reboque_industrial',
      dimensions: { width: 1000, height: 500, depth: 2000 },
      material: 'perfil-u-100x50',
      components: []
    }
  }
];
